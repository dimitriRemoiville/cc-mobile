...
The canonical Feed and Profile features in `.claude/skills/android-app-skeleton/references/feed-feature.md` / `profile-feature.md` are the working examples — clone their shape when adding the next feature.
