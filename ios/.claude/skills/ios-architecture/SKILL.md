...
The canonical layout, and the working `Splash` feature that demonstrates it, live in `.claude/skills/ios-app-skeleton/SKILL.md` and its `references/`. Clone that shape when adding the next feature.
