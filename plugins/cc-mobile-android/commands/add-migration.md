...
4. Ask the user (1 round-trip) for the actual schema change in SQL terms: `ADD COLUMN`, `DROP COLUMN` (requires table recreate), `CREATE TABLE`, `CREATE INDEX`, etc. Don't guess.
5. Generate:
