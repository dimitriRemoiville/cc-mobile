...
1. **Load context.** Read `CLAUDE.md` and skim `${CLAUDE_PLUGIN_ROOT}/skills/ios-architecture/SKILL.md`, `${CLAUDE_PLUGIN_ROOT}/skills/ios-di/SKILL.md`, and `${CLAUDE_PLUGIN_ROOT}/skills/swiftui-views/SKILL.md`.
